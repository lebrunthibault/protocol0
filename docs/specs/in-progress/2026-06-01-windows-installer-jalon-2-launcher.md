...
- Raccourci Internet Shortcut `.url` (menu Démarrer + bureau) vers `http://127.0.0.1:9010/`, créé via
  `[INI]`, nettoyé à la désinstallation. Port 9010 couplé à `LAUNCHER_PORT` côté detector.
