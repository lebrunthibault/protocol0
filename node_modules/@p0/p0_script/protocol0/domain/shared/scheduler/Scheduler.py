...
class Scheduler(object):
    ...
    def __init__(
        self, tick_scheduler: TickSchedulerInterface, beat_scheduler: BeatSchedulerInterface
    ) -> None:
    ...
    @classmethod
    def wait_beats(
        cls, beats: float, callback: Callable, execute_on_song_stop: bool = False
    ) -> None:
    ...
    @classmethod
    def wait(
        cls, tick_count: int, callback: Callable, unique: bool = False
    ) -> TickSchedulerEventInterface:
        """
        tick_count ~= 17 ms
    ...
    @classmethod
    def wait_ms(
        cls, duration: int, callback: Callable, unique: bool = False
    ) -> TickSchedulerEventInterface:
