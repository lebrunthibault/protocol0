...
class ScenePositionScroller(ValueScroller):
    def __init__(self, scene_length: SceneLength, scene_playing_state: ScenePlayingState) -> None:
    ...
    def set_value(self, bar_position: int) -> None:
    ...
    def _get_initial_value(self, go_next: bool) -> int:
