...
# P0_SOURCE_DIR is rewritten by `make install` (scripts/install_remote_script.py)
# to point at the checked-out script repo, so changes to protocol0/ are picked up
