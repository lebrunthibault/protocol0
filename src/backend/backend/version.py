...
paquets tournent depuis des contextes différents (poetry run, Ableton, exe gelé) :
on tente d'abord le bundle PyInstaller (_MEIPASS), puis on remonte depuis __file__
jusqu'à trouver VERSION.
"""
import sys
