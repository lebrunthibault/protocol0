 ...
 */
export function exposeToProtocol0(opts) {
...
// --- internals -------------------------------------------------------------
async function handleRequest(req, res, name, actions, spec) {
...
function buildOpenApiSpec(name, actions) {
    const paths = {};
...
async function announce(endpoint, body) {
    try {
