...
from protocol0.plugins.live_set_old.LiveSetNotes import (
    make_clip_monophonic,
    quantize_bar_notes,
    split_bar_notes,
    determine_captured_clip_bar_length,
)
from protocol0.plugins.live_set_old.LiveTrack import LiveTrack
from protocol0.plugins.live_set_old.ec4 import send_ec4_select_group
from protocol0.shared.Song import Song
from protocol0.shared.logging.StatusBar import StatusBar
from protocol0.shared.sequence.Sequence import Sequence


class LiveSetOldPlugin(PluginInterface, SlotManager):
    name = "live_set_old"
